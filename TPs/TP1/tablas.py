...
def guardarTabla(listaMaximos,listaMinimos,listaPromedios,titulo):
    ...
    workbook = xs.Workbook('E:/MaquinaVieja/UTN/6t0/Algoritmos Geneticos/AlgoritmosGeneticos/TPs/TP1/TABLA200/' + tituloOP + '.xlsx')
    dfOP.to_excel(excel_writer='E:/MaquinaVieja/UTN/6t0/Algoritmos Geneticos/AlgoritmosGeneticos/TPs/TP1/TABLA200/' + tituloOP + '.xlsx')
